...
export default function MiniLeaderboard() {
    return (
        <div >
            ...
            <div className="bg-amber-200 rounded-xl shadow-xl w-[4.5in] h-[3.5in] p-12 flex flex-col justify-between">
                <h2 className=" text-lg font-bold text-center text-green-700 mb-2">Top 3 Players</h2>
